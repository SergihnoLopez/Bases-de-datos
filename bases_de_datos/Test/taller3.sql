...
CREATE INDEX `fk_course_program_idx` ON `course`.`course` (`program_idprogram` ASC);
...
CREATE INDEX `fk_teacher_has_course_course1_idx` ON `course`.`teacher_has_course` (`course_idcourse` ASC, `course_program_idprogram` ASC);

CREATE INDEX `fk_teacher_has_course_teacher1_idx` ON `course`.`teacher_has_course` (`teacher_idteacher` ASC);
...
CREATE INDEX `fk_group_course1_idx` ON `course`.`group` (`course_idcourse` ASC, `course_program_idprogram` ASC);

CREATE INDEX `fk_group_classroom1_idx` ON `course`.`group` (`classroom_idclassroom` ASC);

CREATE INDEX `fk_group_schedule1_idx` ON `course`.`group` (`schedule_idtable1` ASC);
...
CREATE INDEX `fk_student_has_group_group1_idx` ON `course`.`student_has_group` (`group_idgroup` ASC);

CREATE INDEX `fk_student_has_group_student1_idx` ON `course`.`student_has_group` (`student_idstudent` ASC);

CREATE INDEX `fk_student_has_group_payment1_idx` ON `course`.`student_has_group` (`payment_idpayment` ASC);
...
CREATE INDEX `fk_grade_group1_idx` ON `course`.`grade` (`group_idgroup` ASC, `group_course_idcourse` ASC, `group_course_program_idprogram` ASC);
